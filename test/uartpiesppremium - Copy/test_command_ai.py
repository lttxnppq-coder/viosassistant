...
CASES: list[tuple[str, str, int | None, int | None]] = [
    ...
    # ---- NHOM 7c: AIR_AUTO (tu dong / auto - dung don) ----
    ("tự động", "AIR_AUTO", 11, None),
    ("tu dong", "AIR_AUTO", 11, None),
    ("auto", "AIR_AUTO", 11, None),
    ("tự động điều hòa", "AIR_AUTO", 11, None),
    ("tự động máy lạnh", "AIR_AUTO", 11, None),
    ("cho gió tự động", "AIR_AUTO", 11, None),
    ("bật tự động", "AIR_AUTO", 11, None),
    ("tu dong mat va chan", "AIR_AUTO", 11, None),
    # ---- NHOM 7d: NEGATION van duy tri ----
    ("không tự động", "UNKNOWN", None, None),
    # ---- NHOM 9: AIR_DEFROST ----
